...
class QuestionModelClass(TestCase):
...
class QuestionIndexViewTest(TestCase):
    ...
    def test_no_question(self):
        """
        If no question exist, na appropriate message is displayed
        """
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both future and past question exist, only past question are displayed
        """
        create_question(question_test="Past question", days=-30)
        create_question(question_test="Future question.", days=30)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_two_past_question(self):
        ...
        create_question(question_test="Past question 1.", days=-5)
        response=self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
                response.context['latest_question_list'],
